...
import com.ebanswers.freezer.haixingfridge.FridgeApplication;
import com.ebanswers.freezer.haixingfridge.config.AppConfig;
import com.ebanswers.freezer.haixingfridge.data.Weather;
import com.ebanswers.freezer.haixingfridge.util.Constants;
import com.ebanswers.freezer.haixingfridge.util.LogUtil;
import com.ebanswers.freezer.haixingfridge.util.OSUtil;
    ...
    public void getWeather() {
         ...
         getDataStringAsync(url, new HttpListener<String>() {
             ...
             public void onSuccess(String s, Response<String> response) {
                 ...
                 FridgeApplication.getInstance().setWeather(weather);
